      ...
      <div id="page-installation">
        ...
        <div id="main">
          ...
          <section id="macos-virtualbox" className="main">
            ...
            <p>
              <a href="http://download.virtualbox.org/virtualbox/5.2.26/VirtualBox-5.2.26-128414-OSX.dmg" className="button special">
                    <i className="fas fa-download fa-sm"></i> VirtualBox v5.2.26
              </a>
            </p>
          ...
          <section id="macos-docker-desktop" className="main">
            ...
            <p>
              <a href="https://download.docker.com/mac/stable/Docker.dmg" className="button special ">
                    <i className="fas fa-download fa-sm"></i> Docker Desktop for Mac v2.3.0.3 (or higher)
              </a>
            </p>
          ...
          <section id="windows-docker-desktop" className="main">
            ...
            <p></p>
            <p>
              <a href="https://download.docker.com/win/stable/Docker%20Desktop%20Installer.exe" className="button special ">
                    <i className="fas fa-download fa-sm"></i> Docker Desktop for Windows v2.3.0.3 (or higher)
              </a>
            </p>
